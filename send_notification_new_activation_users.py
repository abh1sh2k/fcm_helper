...
if __name__ == '__main__':
    ...
    _botoHelper.downloadFilesFromS3('notification/activation_users/'+s3_key_suffix , local_dir  , local_file_name_prefix )
    uncompressGzipFilesinDir(local_dir)
    payload = {"title": "One phone, 400,000+ remotes", "url": "peel://home/", "strategic": "True", "priority": "high", "message": "Learn how you can use your smartphone to control your TV, AC, home theater and more.", "type": "URL","source":"fcm"}
